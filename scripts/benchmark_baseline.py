...
def write_markdown(path: Path, result: dict) -> None:
    ...
    lines = [
        ...
        f"| qwen_key_buffer_local_rank_mib | {result['runtime_buffer_storage']['qwen35_key_buffer_bytes'] / 1024 / 1024:.2f} |",
        f"| qwen_key_buffer_allocations | {result['runtime_buffer_storage']['qwen35_key_buffer_allocation_count']} |",
        f"| qwen_key_buffer_reuses | {result['runtime_buffer_storage']['qwen35_key_buffer_reuse_count']} |",
